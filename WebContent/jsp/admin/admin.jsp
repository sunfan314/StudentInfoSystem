...
<body class="easyui-layout">
	<div region="north" class="north" title="管理员用户界面">
		<h3>欢迎,&nbsp;${user.username}</h3>
	</div>
	<div region="center" title="功能面板">
		<div class="easyui-tabs" fit="true" border="false" id="tabs">
			<div title="首页">
				<h1 style="font-size: 30px; margin: 40px;">欢迎来到管理员用户界面</h1>
			</div>
	...
	<script>
		...
		var treeData = [ {
			...
			children : [ {
				text : "课程管理",
				attributes : {
					url : "courseManage.action"
				}
			}, {
				text : "教师分配",
				attributes : {
					url : "teacherAllocation.action"
				}
			} ]
		}, {
			text : "班级管理",
